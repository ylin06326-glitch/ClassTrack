...
"""
ClassTrack 打包配置 — 免锁版(FastAPI + Vue3 前后端分离架构)
============================================================
与 ClassTrack.spec 相同,区别:
- 入口: launcher_nolock.py(关闭单实例锁,允许多开)
- 输出名: ClassTrack-Free

构建前置:
    cd frontend && npm run build
    pyinstaller ClassTrack_nolock.spec
"""
import os
...
datas = collect_tree('frontend/dist', 'frontend/dist', ['.map'])
binaries = []
hiddenimports = [
    # FastAPI / uvicorn 技术栈

...
def _verify_activation_uncached() -> ActivationStatus:
    ...
    from app.activation.hardware_id import collect_hardware_id, hardware_id_to_machine_code
    from app.activation.crypto import decode_activation_file, payload_to_bytes
    from app.activation.key_pair import get_public_key
    ...
    from app.activation.crypto import verify_signature
...
def export_fingerprint() -> str:
    ...
    import base64
    from app.activation.hardware_id import collect_hardware_id
...
def generate_activation(private_key_pem: str, hardware_id_raw: str) -> str | None:
    ...
    """
    from app.activation.crypto import (

  ...
  <div class="mobile-page">
    ...
    <div v-if="certVisible" class="cert-hint">
      ...
      <div class="cert-hint-actions">
        ...
        <button class="cert-dismiss-btn" @click="onCertDismiss">我知道了，先试用</button>
      </div>
    ...
    <!-- 控制按钮 -->
    <div class="controls">
      <button class="btn btn-start" :disabled="starting" @click="startScan">
        {{ starting ? '⏳ 启动中...' : '▶ 开始扫描' }}
      </button>
      <button v-show="scanning" class="btn btn-stop" @click="stopScan">⏹ 停止扫描</button>
    </div>

      ...
      <div class="card-body">
        ...
        <div v-else class="import-panel text-panel">
          ...
          <div class="import-text-actions">
            ...
            <GlassButton @click="onConfirmTextImport">✓ 确认导入</GlassButton>
          </div>
        </div>
...
>{{ n }}组</GlassButton>
            ...
            >
            <GlassButton :disabled="store.isLocked" @click="onApplyCount">✓ 应用</GlassButton>
          </div>
        </div>
        <div class="control-center">
          <span v-if="selectedCount > 0" class="selection-info">
            已选 <strong>{{ selectedCount }}</strong> 人
            <GlassButton @click="deselectAll">取消全选</GlassButton>
          </span>
        </div>
        <div class="control-right">
          <GlassButton :disabled="store.isLocked" @click="onResetGroups">🔄 重新分组</GlassButton>
          <GlassButton @click="onExportGroups">📥 导出分组名单</GlassButton>
          <GlassButton v-if="!store.isLocked" @click="onLockGroups">🔒 确定锁定</GlassButton>
          <GlassButton v-else @click="onUnlockGroups">🔓 解锁分组</GlassButton>
          <GlassButton title="AI智能均衡分组" :disabled="store.isLocked" @click="smartVisible = true">🧠 AI智能分组</GlassButton>
        </div>
      </div>
    ...
    <div v-if="selectedCount > 0" class="select-toolbar">
      <GlassButton @click="selectAll">☑ 全选所有</GlassButton>
      <GlassButton @click="deselectAll">☐ 取消全选</GlassButton>
      <GlassButton @click="onDeleteSelected">🗑 删除选中</GlassButton>
    </div>
      ...
      >
        ...
        <div class="group-students">
          ...
          >
            ...
            <GlassButton title="删除学生" @click.stop="onDeleteStudent(s)">✕</GlassButton>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="ct-card unassigned-card">
      <div class="unassigned-header">
        ...
        <GlassButton title="一键清除未分组学生" @click="onClearPool">🗑 清空名单池</GlassButton>
      </div>
      <div
